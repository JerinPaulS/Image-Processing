...
classes = []
filename = '/media/jerinpaul/New Volume/Datasets/lung_colon_image_set'
for sub_folder in os.listdir(os.path.join(filename,'colon_image_sets')):
...
image_size = 160
for i in classes:
    path_train = os.path.join(filename, 'colon_image_sets', i)
    count = 0
...
plt.savefig('/media/jerinpaul/New Volume/Models/ColonLA.png')
plt.plot()
plt.show()
...
plt.savefig('/media/jerinpaul/New Volume/Models/ColonCM.png')
plt.plot()
plt.show()
